...
<body>
    ...
    <form method="POST" action="{{ route ('peminjam.store')}}">
        ...
        <input type="text" class="form-control" id="kode_peminjam" placeholder="Masukan kode peminjam" name="id_user">
        ...
        <input type="date" class="form-control" id="tanggal_peminjaman" placeholder="Masukan TANGGAL PEMINJAM anda" name="tanggal_peminjaman">
        <label for="waktukembali" class="form-label">TANGGAL PENGEMBALIAN</label>
        <input type="date" class="form-control" id="tanggal_kembali" placeholder="Masukan TANGGAL PENGEMBALIAN anda" name="tanggal_kembali">
        ...
        <input type="text" class="form-control" id="kondisi" placeholder="Masukan kondisi barang" name="kondisi">
